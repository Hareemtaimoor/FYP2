...
namespace FYP2.Models
{
    ...
    public partial class Teacher_Evaluation_SystemEntities3 : DbContext
    {
        public Teacher_Evaluation_SystemEntities3()
            : base("name=Teacher_Evaluation_SystemEntities3")
        {
        }
        ...
        public virtual DbSet<EMPMTR_0> EMPMTR_0 { get; set; }
